...
This styleguide aims to make an standard for the projects built with this architecture, following some of the Angular Style Guide conventions with some adjustments.
